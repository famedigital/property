...
Plan only — **[Download complete visual plan (HTML)](docs/COMPLETE_SYSTEM_PLAN.html)** (open in browser → Download HTML or Print / Save PDF).
...
- [`docs/COMPLETE_SYSTEM_PLAN.html`](docs/COMPLETE_SYSTEM_PLAN.html) — visual plan with diagrams
